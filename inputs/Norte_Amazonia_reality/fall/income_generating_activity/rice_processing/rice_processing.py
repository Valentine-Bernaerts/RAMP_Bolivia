# off-grid, likely diesel-genset powered -- relevant for diesel accounting at the Demands/supply stage, not here.
...
RP_dryer = RP.add_appliance(1, 2500, 1, 480, 0.2, 30, wd_we_type=0, occasional_use=0.33)
...
RP_huller = RP.add_appliance(1, 2000, 1, 300, 0.2, 30, wd_we_type=0, occasional_use=0.33)
...
RP_polisher = RP.add_appliance(1, 1500, 1, 300, 0.2, 30, wd_we_type=0, occasional_use=0.33)
RP_polisher.windows([420, 1080], [0, 0], 0.2)

# Sorter/grader (vibrating screen, 200-300 kg/h)
# Source: Kapur et al. (2012), PMC4571202
RP_sorter = RP.add_appliance(1, 1000, 1, 300, 0.2, 15, wd_we_type=0, occasional_use=0.33)
RP_sorter.windows([420, 1080], [0, 0], 0.2)

# Packaging machine (small semi-automatic)
# Source: manufacturer specs (Victor Rice Mill)
RP_packaging = RP.add_appliance(1, 400, 1, 180, 0.2, 10, wd_we_type=0, occasional_use=0.33)
